...
class SessionDao {
    ...
    // function to find a session by refresh token and session id
    ...
    // function to delete a session by refresh token and session id
    ...
    // function to update a session by refresh token and session id
