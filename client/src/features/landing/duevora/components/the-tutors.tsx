...
export default function TheTutors({
		...
		<motion.div
			...
			<div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-5 md:gap-2 pt-20 md:pt-60 px-5 md:px-10">
				<AnimatedText
					...
					className="text-[70px] sm:text-[100px] md:text-[200px] uppercase leading-none font-humaneMedium text-white"
				/>
	...
	AI automation.
			...
			<div className="w-full flex flex-col md:flex-row items-start md:items-center justify-center px-5 md:px-10 py-20 md:py-40 gap-10 md:gap-20">
	<div className="flex items-end">
		<h2 className="text-[80px] md:text-[120px] uppercase leading-[0.8] text-[#5546FF] font-humaneMedium">
			10X
		</h2>
	...
	<div className="flex items-end">
		<h2 className="text-[80px] md:text-[120px] uppercase leading-[0.8] text-[#FF7BCA] font-humaneMedium">
			14+
		</h2>
		<p className="text-white/50 uppercase text-[16px] py-2 px-4">
	...
	<div className="flex items-end">
		<h2 className="text-[80px] md:text-[120px] uppercase leading-[0.8] text-[#BFFF0A] font-humaneMedium">
			2-HRS
		</h2>
		<p className="text-white/50 uppercase text-[16px] py-2 px-4">
	...
	<div className="flex items-end">
		<h2 className="text-[80px] md:text-[120px] uppercase leading-[0.8] text-white font-humaneMedium">
			100%
		</h2>
		<p className="text-white/50 uppercase text-[16px] py-2 px-4">
			Browser<br />Privacy
