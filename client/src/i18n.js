...
export const LANGUAGE_STORAGE_KEY = "autoshorts_ui_language";
...
const SMART_FRAME_COPY = {
  en: {
    smartFrameCurrentClip: "Smart Reframe Clip",
    smartFrameCurrentClipHint: "Sparse subject detection, optical flow motion tracking, and smooth crop path generation.",
    smartFrameGpuPreferred: "WebGPU detection preferred · WASM compatible",
    smartFrameSelectClip: "Select an image or video clip first",
    smartFrameSelectClipHint: "Smart Frame will only modify the currently selected Visuals clip.",
    smartFrameTargetRatio: "Target Aspect Ratio",
    smartFrameMotion: "Camera Tracking",
    smartFrameMotionHint: "Re-solves path only without re-downloading model",
    smartFrameMotion_locked: "Static",
    smartFrameMotionHint_locked: "Minimal movement",
    smartFrameMotion_smooth: "Smooth",
    smartFrameMotionHint_smooth: "Naturally follow subject",
    smartFrameMotion_responsive: "Responsive",
    smartFrameMotionHint_responsive: "Quickly respond to motion",
    smartFramePadding: "Subject Margin",
    smartFrameCancelAnalysis: "Cancel Analysis",
    smartFrameAnalyzeAgain: "Re-analyze Current Clip",
    smartFrameAnalyzeClip: "Analyze & Generate Framing Preview",
    smartFrameModelSetup: "Preparing Model",
    smartFrameClipAnalysis: "Analyzing Clip",
    smartFrameCompare: "Comparison",
    smartFrameBefore: "Original",
    smartFrameAfter: "Framed",
    smartFrameAnchors: "Anchors",
    smartFrameFlowFrames: "Flow Frames",
    smartFramePathPoints: "Path Keyframes",
    smartFrameWebGpuRuntime: "WebGPU Detection · WASM Optical Flow",
    smartFrameWasmRuntime: "WASM Compatibility Mode",
    smartFrameLegacyRuntime: "Legacy result · Re-analyze to enable WebGPU",
    smartFrameSafeContain: "The current aspect ratio cannot preserve the head solely via cropping; switched to smart stage framing. Other aspect ratios remain independent.",
    smartFrameRemove: "Remove Smart Frame from Current Clip",
    smartFrameLocalNote: "Media stays local in browser; preview, restore, and export share the same crop path.",
  },
  zh: {
    smartFrameCurrentClip: "当前片段智能改画幅",
    ...
    smartFrameMotion_locked: "稳镜",
    smartFrameMotionHint_locked: "尽量不移动",
    smartFrameMotion_smooth: "平滑",
    smartFrameMotionHint_smooth: "自然跟随主体",
    smartFrameMotion_responsive: "灵敏",
    smartFrameMotionHint_responsive: "快速响应运动",
    ...
    smartFrameRemove: "移除当前片段的 Smart Frame",
    smartFrameLocalNote: "媒体留在浏览器本地；预览、工程恢复和导出使用同一条裁切路径。",
  },
  ja: {
    smartFrameCurrentClip: "クリップのスマート構図",
    smartFrameCurrentClipHint: "被写体を疎に検出し、オプティカルフローで動きを追従して滑らかなクロップパスを生成します。",
    smartFrameGpuPreferred: "WebGPU 検出優先 · WASM 自動互換",
    smartFrameSelectClip: "画像または動画クリップを選択してください",
    smartFrameSelectClipHint: "Smart Frame は現在選択されている Visuals クリップのみを変更します。",
    smartFrameTargetRatio: "目標アスペクト比",
    smartFrameMotion: "カメラ追従",
    smartFrameMotionHint: "モデルを再ダウンロードせずにパスのみ再計算",
    smartFrameMotion_locked: "固定",
    smartFrameMotionHint_locked: "できるだけ動かさない",
    smartFrameMotion_smooth: "滑らか",
    smartFrameMotionHint_smooth: "被写体を自然に追従",
    smartFrameMotion_responsive: "高感度",
    smartFrameMotionHint_responsive: "動きに素早く反応",
    smartFramePadding: "被写体余白",
    smartFrameCancelAnalysis: "解析をキャンセル",
    smartFrameAnalyzeAgain: "現在のクリップを再解析",
    smartFrameAnalyzeClip: "解析して構図プレビューを生成",
    smartFrameModelSetup: "モデル準備中",
    smartFrameClipAnalysis: "クリップ解析中",
    smartFrameCompare: "比較プレビュー",
    smartFrameBefore: "元映像",
    smartFrameAfter: "構図結果",
    smartFrameAnchors: "検出アンカー",
    smartFrameFlowFrames: "フローフレーム",
    smartFramePathPoints: "パスキーフレーム",
    smartFrameWebGpuRuntime: "WebGPU 被写体検出 · WASM オプティカルフロー",
    smartFrameWasmRuntime: "WASM 互換モード",
    smartFrameLegacyRuntime: "従来の解析結果 · 再解析で WebGPU を有効化",
    smartFrameSafeContain: "現在の比率ではクロップのみで頭部を維持できないため、スマートステージ構図に切り替えました。",
    smartFrameRemove: "現在のクリップから Smart Frame を削除",
    smartFrameLocalNote: "メディアはブラウザー内に保持されます。プレビュー、復元、エクスポートで同じパスを使用します。",
  },
  ko: {
    smartFrameCurrentClip: "클립 스마트 구도 변경",
    smartFrameCurrentClipHint: "피사체를 희소 감지하고 옵티컬 플로우로 움직임을 추적하여 부드러운 크롭 경로를 생성합니다.",
    smartFrameGpuPreferred: "WebGPU 감지 우선 · WASM 자동 호환",
    smartFrameSelectClip: "이미지 또는 비디오 클립을 먼저 선택하세요",
    smartFrameSelectClipHint: "Smart Frame은 현재 선택된 Visuals 클립만 수정합니다.",
    smartFrameTargetRatio: "목표 화면비",
    smartFrameMotion: "카메라 추적",
    smartFrameMotionHint: "모델을 다시 다운로드하지 않고 경로만 다시 계산",
    smartFrameMotion_locked: "고정",
    smartFrameMotionHint_locked: "최소한으로 이동",
    smartFrameMotion_smooth: "부드럽게",
    smartFrameMotionHint_smooth: "자연스럽게 피사체 추적",
    smartFrameMotion_responsive: "민감하게",
    smartFrameMotionHint_responsive: "움직임에 빠르게 반응",
    smartFramePadding: "피사체 여백",
    smartFrameCancelAnalysis: "분석 취소",
    smartFrameAnalyzeAgain: "현재 클립 다시 분석",
    smartFrameAnalyzeClip: "분석 및 구도 미리보기 생성",
    smartFrameModelSetup: "모델 준비 중",
    smartFrameClipAnalysis: "클립 분석 중",
    smartFrameCompare: "비교 미리보기",
    smartFrameBefore: "원본 영상",
    smartFrameAfter: "구도 결과",
    smartFrameAnchors: "감지 앵커",
    smartFrameFlowFrames: "플로우 프레임",
    smartFramePathPoints: "경로 키프레임",
    smartFrameWebGpuRuntime: "WebGPU 피사체 감지 · WASM 옵티컬 플로우",
    smartFrameWasmRuntime: "WASM 호환 모드",
    smartFrameLegacyRuntime: "이전 분석 결과 · 다시 분석하여 WebGPU 활성화",
    smartFrameSafeContain: "현재 비율로는 크롭만으로 머리를 보존할 수 없어 스마트 스테이지 구도로 전환되었습니다.",
    smartFrameRemove: "현재 클립에서 Smart Frame 제거",
    smartFrameLocalNote: "미디어는 브라우저 로컬에 유지됩니다. 미리보기, 복원, 내보내기에 동일한 경로가 사용됩니다.",
  },
  es: {
    smartFrameCurrentClip: "Reencuadre inteligente del clip",
    smartFrameCurrentClipHint: "Detección dispersa de sujetos, seguimiento por flujo óptico y generación de ruta de recorte suave.",
    smartFrameGpuPreferred: "Preferencia WebGPU · Compatible con WASM",
    smartFrameSelectClip: "Selecciona primero un clip de imagen o vídeo",
    smartFrameSelectClipHint: "Smart Frame solo modificará el clip de Visuals seleccionado actualmente.",
    smartFrameTargetRatio: "Proporción objetivo",
    smartFrameMotion: "Seguimiento de cámara",
    smartFrameMotionHint: "Recalcula solo la ruta sin volver a descargar el modelo",
    smartFrameMotion_locked: "Fijo",
    smartFrameMotionHint_locked: "Movimiento mínimo",
    smartFrameMotion_smooth: "Suave",
    smartFrameMotionHint_smooth: "Sigue al sujeto de forma natural",
    smartFrameMotion_responsive: "Sensible",
    smartFrameMotionHint_responsive: "Responde rápidamente al movimiento",
    smartFramePadding: "Margen del sujeto",
    smartFrameCancelAnalysis: "Cancelar análisis",
    smartFrameAnalyzeAgain: "Volver a analizar clip actual",
    smartFrameAnalyzeClip: "Analizar y generar vista previa",
    smartFrameModelSetup: "Preparando modelo",
    smartFrameClipAnalysis: "Analizando clip",
    smartFrameCompare: "Comparación",
    smartFrameBefore: "Original",
    smartFrameAfter: "Encuadrado",
    smartFrameAnchors: "Puntos de anclaje",
    smartFrameFlowFrames: "Fotogramas de flujo",
    smartFramePathPoints: "Fotogramas clave de ruta",
    smartFrameWebGpuRuntime: "Detección WebGPU · Flujo óptico WASM",
    smartFrameWasmRuntime: "Modo de compatibilidad WASM",
    smartFrameLegacyRuntime: "Resultado anterior · Vuelve a analizar para activar WebGPU",
    smartFrameSafeContain: "La proporción actual no puede conservar la cabeza solo recortando; se cambió a encuadre de escenario inteligente.",
    smartFrameRemove: "Eliminar Smart Frame del clip actual",
    smartFrameLocalNote: "El contenido permanece local en el navegador; la vista previa y la exportación comparten la misma ruta.",
  },
  fr: {
    smartFrameCurrentClip: "Recadrage intelligent du clip",
    smartFrameCurrentClipHint: "Détection du sujet, suivi par flux optique et génération d'une trajectoire fluide.",
    smartFrameGpuPreferred: "WebGPU prioritaire · Compatible WASM",
    smartFrameSelectClip: "Sélectionnez d'abord un clip image ou vidéo",
    smartFrameSelectClipHint: "Smart Frame ne modifiera que le clip Visuals sélectionné.",
    smartFrameTargetRatio: "Format cible",
    smartFrameMotion: "Suivi caméra",
    smartFrameMotionHint: "Recalcule uniquement la trajectoire sans retélécharger le modèle",
    smartFrameMotion_locked: "Fixe",
    smartFrameMotionHint_locked: "Mouvement minimal",
    smartFrameMotion_smooth: "Fluide",
    smartFrameMotionHint_smooth: "Suit naturellement le sujet",
    smartFrameMotion_responsive: "Réactif",
    smartFrameMotionHint_responsive: "Réagit rapidement aux mouvements",
    smartFramePadding: "Marge du sujet",
    smartFrameCancelAnalysis: "Annuler l'analyse",
    smartFrameAnalyzeAgain: "Réanalyser le clip actuel",
    smartFrameAnalyzeClip: "Analyser et générer l'aperçu",
    smartFrameModelSetup: "Préparation du modèle",
    smartFrameClipAnalysis: "Analyse du clip",
    smartFrameCompare: "Comparaison",
    smartFrameBefore: "Original",
    smartFrameAfter: "Cadré",
    smartFrameAnchors: "Ancres de détection",
    smartFrameFlowFrames: "Images de flux",
    smartFramePathPoints: "Images clés de trajectoire",
    smartFrameWebGpuRuntime: "Détection WebGPU · Flux optique WASM",
    smartFrameWasmRuntime: "Mode de compatibilité WASM",
    smartFrameLegacyRuntime: "Ancien résultat · Réanalysez pour activer WebGPU",
    smartFrameSafeContain: "Le format actuel ne peut pas préserver la tête uniquement par recadrage ; basculé en cadrage scène intelligent.",
    smartFrameRemove: "Supprimer Smart Frame du clip actuel",
    smartFrameLocalNote: "Les médias restent locaux dans le navigateur ; aperçu et export partagent la même trajectoire.",
  },
  de: {
    smartFrameCurrentClip: "Clip intelligent anpassen",
    smartFrameCurrentClipHint: "Objekterkennung, optisches Fluss-Tracking und Berechnung eines weichen Schnittpfads.",
    smartFrameGpuPreferred: "WebGPU bevorzugt · WASM-kompatibel",
    smartFrameSelectClip: "Wählen Sie zuerst einen Bild- oder Videoclip aus",
    smartFrameSelectClipHint: "Smart Frame ändert nur den aktuell ausgewählten Visuals-Clip.",
    smartFrameTargetRatio: "Ziel-Seitenverhältnis",
    smartFrameMotion: "Kameraverfolgung",
    smartFrameMotionHint: "Berechnet nur den Pfad neu, ohne das Modell erneut herunterzuladen",
    smartFrameMotion_locked: "Statisch",
    smartFrameMotionHint_locked: "Minimale Bewegung",
    smartFrameMotion_smooth: "Weich",
    smartFrameMotionHint_smooth: "Folgt dem Motiv natürlich",
    smartFrameMotion_responsive: "Reaktionsschnell",
    smartFrameMotionHint_responsive: "Reagiert schnell auf Bewegungen",
    smartFramePadding: "Motiv-Randabstand",
    smartFrameCancelAnalysis: "Analyse abbrechen",
    smartFrameAnalyzeAgain: "Aktuellen Clip erneut analysieren",
    smartFrameAnalyzeClip: "Analysieren und Bildausschnitt-Vorschau erzeugen",
    smartFrameModelSetup: "Modell wird vorbereitet",
    smartFrameClipAnalysis: "Clip wird analysiert",
    smartFrameCompare: "Vergleichsvorschau",
    smartFrameBefore: "Original",
    smartFrameAfter: "Angepasst",
    smartFrameAnchors: "Erkennungsanker",
    smartFrameFlowFrames: "Fluss-Frames",
    smartFramePathPoints: "Pfad-Keyframes",
    smartFrameWebGpuRuntime: "WebGPU-Erkennung · WASM-Fluss-Tracking",
    smartFrameWasmRuntime: "WASM-Kompatibilitätsmodus",
    smartFrameLegacyRuntime: "Altes Ergebnis · Erneut analysieren, um WebGPU zu aktivieren",
    smartFrameSafeContain: "Das aktuelle Seitenverhältnis kann den Kopf nicht allein durch Beschneiden erhalten; auf intelligente Bühnenanpassung umgestellt.",
    smartFrameRemove: "Smart Frame vom aktuellen Clip entfernen",
    smartFrameLocalNote: "Medien verbleiben lokal im Browser; Vorschau und Export nutzen denselben Schnittpfad.",
  },
  pt: {
    smartFrameCurrentClip: "Reenquadrar clipe inteligente",
    smartFrameCurrentClipHint: "Detecção esparsa de sujeitos, rastreamento por fluxo óptico e geração suave de caminho de corte.",
    smartFrameGpuPreferred: "Preferência WebGPU · Compatível com WASM",
    smartFrameSelectClip: "Selecione um clipe de imagem ou vídeo primeiro",
    smartFrameSelectClipHint: "O Smart Frame modificará apenas o clipe de Visuals atualmente selecionado.",
    smartFrameTargetRatio: "Proporção de tela",
    smartFrameMotion: "Rastreamento de câmera",
    smartFrameMotionHint: "Recalcula apenas o caminho sem baixar o modelo novamente",
    smartFrameMotion_locked: "Fixo",
    smartFrameMotionHint_locked: "Movimento mínimo",
    smartFrameMotion_smooth: "Suave",
    smartFrameMotionHint_smooth: "Segue o sujeito naturalmente",
    smartFrameMotion_responsive: "Responsivo",
    smartFrameMotionHint_responsive: "Responde rapidamente ao movimento",
    smartFramePadding: "Margem do sujeito",
    smartFrameCancelAnalysis: "Cancelar análise",
    smartFrameAnalyzeAgain: "Reanalisar clipe atual",
    smartFrameAnalyzeClip: "Analisar e gerar prévia",
    smartFrameModelSetup: "Preparando modelo",
    smartFrameClipAnalysis: "Analisando clipe",
    smartFrameCompare: "Comparação",
    smartFrameBefore: "Original",
    smartFrameAfter: "Enquadrado",
    smartFrameAnchors: "Pontos de ancoragem",
    smartFrameFlowFrames: "Quadros de fluxo",
    smartFramePathPoints: "Quadros-chave de caminho",
    smartFrameWebGpuRuntime: "Detecção WebGPU · Fluxo óptico WASM",
    smartFrameWasmRuntime: "Modo de compatibilidade WASM",
    smartFrameLegacyRuntime: "Resultado antigo · Reanalise para ativar WebGPU",
    smartFrameSafeContain: "A proporção atual não pode preservar a cabeça apenas cortando; alternado para enquadramento inteligente de palco.",
    smartFrameRemove: "Remover Smart Frame do clipe atual",
    smartFrameLocalNote: "A mídia permanece local no navegador; a prévia e a exportação usam o mesmo caminho de corte.",
  },
  th: {
    smartFrameCurrentClip: "จัดองค์ประกอบคลิปอัจฉริยะ",
    smartFrameCurrentClipHint: "ตรวจจับวัตถุ ติดตามการเคลื่อนไหวด้วยออปติคัลโฟลว์ และสร้างเส้นทางการครอปที่ราบรื่น",
    smartFrameGpuPreferred: "แนะนำ WebGPU · เข้ากันได้กับ WASM",
    smartFrameSelectClip: "เลือกคลิปรูปภาพหรือวิดีโอก่อน",
    smartFrameSelectClipHint: "Smart Frame จะแก้ไขเฉพาะคลิป Visuals ที่เลือกอยู่ในปัจจุบันเท่านั้น",
    smartFrameTargetRatio: "อัตราส่วนภาพเป้าหมาย",
    smartFrameMotion: "การติดตามของกล้อง",
    smartFrameMotionHint: "คำนวณเส้นทางใหม่เท่านั้นโดยไม่ต้องดาวน์โหลดโมเดลซ้ำ",
    smartFrameMotion_locked: "คงที่",
    smartFrameMotionHint_locked: "ขยับให้น้อยที่สุด",
    smartFrameMotion_smooth: "ราบรื่น",
    smartFrameMotionHint_smooth: "ติดตามวัตถุอย่างเป็นธรรมชาติ",
    smartFrameMotion_responsive: "ตอบสนองไว",
    smartFrameMotionHint_responsive: "ตอบสนองต่อการเคลื่อนไหวอย่างรวดเร็ว",
    smartFramePadding: "ระยะขอบวัตถุ",
    smartFrameCancelAnalysis: "ยกเลิกการวิเคราะห์",
    smartFrameAnalyzeAgain: "วิเคราะห์คลิปปัจจุบันอีกครั้ง",
    smartFrameAnalyzeClip: "วิเคราะห์และสร้างตัวอย่างองค์ประกอบ",
    smartFrameModelSetup: "กำลังเตรียมโมเดล",
    smartFrameClipAnalysis: "กำลังวิเคราะห์คลิป",
    smartFrameCompare: "เปรียบเทียบ",
    smartFrameBefore: "ต้นฉบับ",
    smartFrameAfter: "จัดเฟรมแล้ว",
    smartFrameAnchors: "จุดยึดการตรวจจับ",
    smartFrameFlowFrames: "เฟรมโฟลว์",
    smartFramePathPoints: "คีย์เฟรมเส้นทาง",
    smartFrameWebGpuRuntime: "การตรวจจับ WebGPU · ออปติคัลโฟลว์ WASM",
    smartFrameWasmRuntime: "โหมดความเข้ากันได้ WASM",
    smartFrameLegacyRuntime: "ผลการวิเคราะห์เดิม · วิเคราะห์ใหม่เพื่อเปิดใช้ WebGPU",
    smartFrameSafeContain: "อัตราส่วนปัจจุบันไม่สามารถรักษาศีรษะไว้ได้ด้วยการครอปเพียงอย่างเดียว จึงเปลี่ยนเป็นการจัดองค์ประกอบแบบเวทีอัจฉริยะ",
    smartFrameRemove: "ลบ Smart Frame ออกจากคลิปปัจจุบัน",
    smartFrameLocalNote: "สื่อจะอยู่บนเบราว์เซอร์ภายในเครื่อง; ตัวอย่างและการส่งออกจะใช้เส้นทางการครอปเดียวกัน",
  },
  vi: {
    smartFrameCurrentClip: "Tự động đổi khung hình đoạn",
    smartFrameCurrentClipHint: "Phát hiện chủ thể, theo dõi chuyển động quang học và tạo đường cắt mượt mà.",
    smartFrameGpuPreferred: "Ưu tiên WebGPU · Tương thích WASM",
    smartFrameSelectClip: "Chọn một đoạn ảnh hoặc video trước",
    smartFrameSelectClipHint: "Smart Frame chỉ chỉnh sửa đoạn Visuals đang được chọn.",
    smartFrameTargetRatio: "Tỷ lệ khung hình",
    smartFrameMotion: "Theo dõi camera",
    smartFrameMotionHint: "Chỉ tính lại đường dẫn mà không tải lại mô hình",
    smartFrameMotion_locked: "Cố định",
    smartFrameMotionHint_locked: "Hạn chế di chuyển",
    smartFrameMotion_smooth: "Mượt mà",
    smartFrameMotionHint_smooth: "Theo dõi chủ thể tự nhiên",
    smartFrameMotion_responsive: "Nhạy",
    smartFrameMotionHint_responsive: "Phản hồi nhanh với chuyển động",
    smartFramePadding: "Lề chủ thể",
    smartFrameCancelAnalysis: "Hủy phân tích",
    smartFrameAnalyzeAgain: "Phân tích lại đoạn hiện tại",
    smartFrameAnalyzeClip: "Phân tích và tạo xem trước bố cục",
    smartFrameModelSetup: "Đang chuẩn bị mô hình",
    smartFrameClipAnalysis: "Đang phân tích đoạn",
    smartFrameCompare: "So sánh",
    smartFrameBefore: "Gốc",
    smartFrameAfter: "Đã đổi khung",
    smartFrameAnchors: "Điểm neo nhận diện",
    smartFrameFlowFrames: "Khung hình luồng",
    smartFramePathPoints: "Keyframe đường dẫn",
    smartFrameWebGpuRuntime: "Nhận diện WebGPU · Luồng quang học WASM",
    smartFrameWasmRuntime: "Chế độ tương thích WASM",
    smartFrameLegacyRuntime: "Kết quả cũ · Phân tích lại để bật WebGPU",
    smartFrameSafeContain: "Tỷ lệ hiện tại không thể giữ nguyên đầu chỉ bằng cách cắt; đã chuyển sang bố cục sân khấu thông minh.",
    smartFrameRemove: "Xóa Smart Frame khỏi đoạn hiện tại",
    smartFrameLocalNote: "Phương tiện lưu cục bộ trong trình duyệt; xem trước và xuất đều dùng cùng đường cắt.",
  },
  ru: {
    smartFrameCurrentClip: "Умное кадрирование клипа",
    smartFrameCurrentClipHint: "Обнаружение объекта, оптический поток движения и плавный путь кадрирования.",
    smartFrameGpuPreferred: "Приоритет WebGPU · Совместимость с WASM",
    smartFrameSelectClip: "Сначала выберите клип с изображением или видео",
    smartFrameSelectClipHint: "Smart Frame изменяет только текущий выбранный фрагмент Visuals.",
    smartFrameTargetRatio: "Целевое соотношение",
    smartFrameMotion: "Слежение камеры",
    smartFrameMotionHint: "Пересчитывает только путь без повторной загрузки модели",
    smartFrameMotion_locked: "Фиксированный",
    smartFrameMotionHint_locked: "Минимальное движение",
    smartFrameMotion_smooth: "Плавный",
    smartFrameMotionHint_smooth: "Естественно следует за объектом",
    smartFrameMotion_responsive: "Быстрый",
    smartFrameMotionHint_responsive: "Быстро реагирует на движение",
    smartFramePadding: "Отступ объекта",
    smartFrameCancelAnalysis: "Отмена анализа",
    smartFrameAnalyzeAgain: "Переанализировать текущий клип",
    smartFrameAnalyzeClip: "Анализ и предварительный просмотр",
    smartFrameModelSetup: "Подготовка модели",
    smartFrameClipAnalysis: "Анализ клипа",
    smartFrameCompare: "Сравнение",
    smartFrameBefore: "Оригинал",
    smartFrameAfter: "В кадре",
    smartFrameAnchors: "Опорные точки",
    smartFrameFlowFrames: "Кадры потока",
    smartFramePathPoints: "Ключевые кадры пути",
    smartFrameWebGpuRuntime: "Детекция WebGPU · Оптический поток WASM",
    smartFrameWasmRuntime: "Режим совместимости WASM",
    smartFrameLegacyRuntime: "Старый результат · Повторите анализ для включения WebGPU",
    smartFrameSafeContain: "Текущее соотношение не позволяет сохранить голову только обрезкой; переключено на умную сцену.",
    smartFrameRemove: "Удалить Smart Frame из текущего клипа",
    smartFrameLocalNote: "Медиафайл обрабатывается локально в браузере; предпросмотр и экспорт используют один и тот же путь.",
  },
};
...
export function createTranslator(languageId) {
  ...
  const specializedCopy = Object.assign({}, ...[
    ...
    CAPTION_DEFAULT_COPY, SMART_WORKSPACE_COPY, SMART_FRAME_COPY, AUTO_EDIT_COPY, AUTO_EDIT_BUTTON_COPY,
